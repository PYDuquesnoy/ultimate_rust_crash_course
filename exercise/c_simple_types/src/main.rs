...
fn main() {
    ...
    //
    let coords_array: [f32 ; 2] = [coords.0,coords.1];   // create an array literal out of parts of `coord` here
    print_array(coords_array);        // and pass it in here (this line doesn't need to change)
